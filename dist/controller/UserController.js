...
var UserController = /** @class */ (function () {
    ...
    UserController.newUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, username, password, role, user, validationOpt, errors, userRepository, e_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    e_2 = _b.sent();
                    return [2 /*return*/, res.status(409).json({ message: 'Username alredy exist' })];
                case 5:
                    //ALL ok
    ...
    UserController.editUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var user, id, _a, username, role, userRepository, e_3, validationOpt, errors, e_4;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    id = req.params.id;
                ...
                case 8:
                    e_4 = _b.sent();
                    return [2 /*return*/, res.status(409).json({ message: 'Username aleredy in use' })];
                case 9:
    ...
    UserController.deleteUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var id, userRepository, user, e_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    id = req.params.id;
